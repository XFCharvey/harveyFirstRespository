package com.cbox.base.core.domain.entity;
...
public class SysUser extends BaseEntity {
	...
	/** 用户级别信息（所有） */
	private String levelAuth;

	/** 用户自身级别信息 */
	private String levelSelfAuth;

	/** 部门向上的权限，逗号分隔 */
	private String upDeptAuth;
	...
	public String getLevelAuth() {
		return levelAuth;
	}

	public void setLevelAuth(String levelAuth) {
		this.levelAuth = levelAuth;
	}

	public String getLevelSelfAuth() {
		return levelSelfAuth;
	}

	public void setLevelSelfAuth(String levelSelfAuth) {
		this.levelSelfAuth = levelSelfAuth;
	}

	public String getUpDeptAuth() {
		return upDeptAuth;
	}

	public void setUpDeptAuth(String upDeptAuth) {
		this.upDeptAuth = upDeptAuth;
	}
