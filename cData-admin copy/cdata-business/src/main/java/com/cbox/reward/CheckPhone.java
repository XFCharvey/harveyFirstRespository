...
public class CheckPhone {
    ...
    /**
     * 中国电信号码格式验证 手机段： 133,153,180,181,189,177,173,1700,199
     **/
    ...
    /**
     * 中国移动号码格式验证 手机段：134,135,136,137,138,139,150,151,152,157,158,159,182,183,184 ,187,188,147,178,172,1705,166,198
     **/
    private static final String CHINA_MOBILE_PATTERN = "(^1(3[4-9]|4[7]|5[0-27-9]|66|7[28]|8[2-478]|98)\\d{8}$)|(^1705\\d{7}$)";
