...
public class PushUtil {
    ...
    /**
     * app 消息推送
     * @param osname os名称 ios或Android
     * @param title 消息标题
     * @param content 消息内容
     * @param clientId 客户端id
     * @param payload 参数，json字符串
     */
    public void send(String osname, String title, String content, String clientId, Map<String, Object> param) {
        ...
        if ("ios".equalsIgnoreCase(osname)) {
            ...
            notification.setTitle(title);// 安卓离线通知栏标题
            notification.setBody(content);// 安卓离线展示的内容
            notification.setClickType("intent");
            notification.setIntent("intent:#Intent;launchFlags=0x04000000;action=android.intent.action.oppopush;component=" + pkgName + "/io.dcloud.PandoraEntry;S.UP-OL-SU=true;S.title=" + title
                    + ";S.content=" + content + ";S.payload=" + payload + ";end");
            System.out.println(notification.getIntent());
            // 各厂商自有功能单项设置
