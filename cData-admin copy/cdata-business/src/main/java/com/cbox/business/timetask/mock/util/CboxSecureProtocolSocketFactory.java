...
/**
 * @ClassName: CboxSecureProtocolSocketFactory 
 * @Function:用作绕过https的证书校验  
 * 
 * @author qiuzq 
 * @date 2021年11月9日 上午11:05:41 
 * @version 1.0
 */
public class CboxSecureProtocolSocketFactory implements SecureProtocolSocketFactory {
     ...
     */
    public CboxSecureProtocolSocketFactory() {
    }
    ...
    private static SSLContext createEasySSLContext() {
        try {
            ...
            context.init(null, new TrustManager[] { new CboxX509TrustManager() }, null);
            return context;
        } catch (Exception e) {
